...
use windows::Win32::{
    ...
    Graphics::Gdi::{
        CreatePen, CreateSolidBrush, DeleteObject, GetDC, GetMonitorInfoW, HMONITOR,
        InvalidateRect, MONITORINFO, PS_SOLID, Rectangle, ReleaseDC, SelectObject, UpdateWindow,
    },
