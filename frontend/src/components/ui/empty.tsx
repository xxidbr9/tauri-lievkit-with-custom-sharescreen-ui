        ...
        <>
          <div
            ...
            className={cn(
              ...
              "-translate-x-0.5 rtl:translate-x-0.5 -rotate-10 pointer-events-none absolute bottom-px origin-bottom-start scale-84 shadow-none",
            )}
          />
          <div
            aria-hidden="true"
            className={cn(
              emptyMediaVariants({ className, variant }),
              "pointer-events-none absolute bottom-px origin-bottom-end translate-x-0.5 rtl:-translate-x-0.5 rotate-10 scale-84 shadow-none",
            )}
          />
        </>
      )}
